...
Tests whether chaining an LLM's local reads of when events happen through a logic closure engine recovers orderings the reads miss, beating strong baselines and cutting confident-wrong errors across 600 real-text queries.
