# Natural-Text Absent-Relation Kinship Corpus from Re-DocRED + DocRED
...
A corpus of real Wikipedia biographies labeled with family relationships, including pairs that are genuinely unrelated, used to test whether a logic engine can correctly say "no relation" instead of hallucinating one.
...
- `art_Dm5vYXmD1R8h` — kinship-table-specs
