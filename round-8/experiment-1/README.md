...
Tests whether a logic-based abstention rule catches confident geographic-containment hallucinations that confidence scores and a false-premise verifier miss, on natural Wikipedia text.
