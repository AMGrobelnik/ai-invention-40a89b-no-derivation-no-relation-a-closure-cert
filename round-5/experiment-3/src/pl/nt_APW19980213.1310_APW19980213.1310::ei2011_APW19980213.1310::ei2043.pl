...
% --- query: intersect every e_APW19980213_1310__ei2011->M->e_APW19980213_1310__ei2043 composition ---
path_comp(e_APW19980213_1310__ei2011,e_APW19980213_1310__ei2043,R) :- rel(e_APW19980213_1310__ei2011,M,R1), rel(M,e_APW19980213_1310__ei2043,R2), comp(R1,R2,R).
main :- ( setof(R, path_comp(e_APW19980213_1310__ei2011,e_APW19980213_1310__ei2043,R), Rs) -> format('PATHS: ~w~n',[Rs]) ; write('PATHS: none'), nl ), halt.
