...
% --- query: intersect every e_APW19980227_0494__ei2348->M->e_APW19980227_0494__ei2366 composition ---
path_comp(e_APW19980227_0494__ei2348,e_APW19980227_0494__ei2366,R) :- rel(e_APW19980227_0494__ei2348,M,R1), rel(M,e_APW19980227_0494__ei2366,R2), comp(R1,R2,R).
main :- ( setof(R, path_comp(e_APW19980227_0494__ei2348,e_APW19980227_0494__ei2366,R), Rs) -> format('PATHS: ~w~n',[Rs]) ; write('PATHS: none'), nl ), halt.
