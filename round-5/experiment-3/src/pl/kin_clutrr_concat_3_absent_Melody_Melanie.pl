...
seed('Sharon','sibling','Kathleen').
seed('Sharon','inv-child','James').
seed('Mabel','sibling','Kathleen').
seed('Mabel','sibling','Sharon').
seed('Ellen','child','Nadia').
seed('Nadia','sibling','Sharon').
seed('Don','inv-child','Steve').
seed('Don','sibling','Stanley').
seed('Margaret','sibling','Steve').
seed('Margaret','sibling','James').
seed('Maria','sibling','Donald').
seed('Dallas','child','Katherine').
seed('Katherine','child','Melody').
seed('Donald','un','David').
seed('Gerald','sibling','David').
seed('Gerald','sibling','Katherine').
seed('Cecelia','inv-child','Melody').
seed('Diane','sibling','Alfred').
seed('Paul','sibling','Harry').
seed('Stephen','child','Diane').
seed('Gayle','SO','Carlos').
seed('Alfred','inv-un','Gayle').
seed('Carlos','SO','Gayle').
seed('John','sibling','Kyle').
seed('John','sibling','Bonita').
seed('Wallace','sibling','Helen').
seed('Donna','sibling','Kyle').
seed('Donna','sibling','Willie').
seed('Marie','inv-child','Mark').
seed('Leah','sibling','Marie').
seed('Leah','sibling','Helen').
seed('Bonita','sibling','Mark').
seed('Arlene','inv-un','Melanie').
seed('Samuel','sibling','Melanie').
seed('Nancy','SO','Samuel').
seed('Milton','child','Arlene').
seed('Patrick','sibling','Ross').
seed('Ross','sibling','Alfredo').
seed('Ross','sibling','Patrick').
seed('Robert','inv-un','Alfredo').
seed('Erica','child','Ross').
seed('Erica','SO','Joseph').
...
run :- init_seed, one_pass,
       ( setof(R, der('Melody',R,'Melanie'), Rs) -> true ; Rs = [] ),
