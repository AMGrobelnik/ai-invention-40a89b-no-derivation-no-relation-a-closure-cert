...
seed('Belva','inv-grand','Ashley').
seed('Nicolas','sibling','Belva').
seed('Nicolas','inv-grand','Ashley').
seed('Tony','sibling','June').
seed('Clarence','grand','Tony').
...
run :- init_seed, one_pass,
       ( setof(R, der('Clarence',R,'Nicolas'), Rs) -> true ; Rs = [] ),
