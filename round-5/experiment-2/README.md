...
An LLM reads vague spatial and ambiguous kinship phrases as calibrated probability disjunctions, and a symbolic certificate lets the system abstain instead of guessing wrong.
