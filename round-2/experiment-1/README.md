...
Tests whether a symbolic logic engine fed an LLM's piecemeal readings of a text beats the LLM's own multi-step reasoning at answering questions that require chaining facts together.
