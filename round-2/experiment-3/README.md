...
Tests whether chaining a logic reasoner over an LLM's local reads of a document recovers temporal facts the LLM misses alone, and whether it cuts confident wrong answers.
...
- `art_aQ2Rf8rwqteI` — baseline-specs
