# Spatial multi-path-redundancy gold-QCN corpus: iter-5 prevalence gate
...
A zero-cost dataset that measures, across published spatial-reasoning corpora, how often two objects are linked by two or more independent reasoning paths — telling the next experiment which corpora can actually test cross-path logical inference.
