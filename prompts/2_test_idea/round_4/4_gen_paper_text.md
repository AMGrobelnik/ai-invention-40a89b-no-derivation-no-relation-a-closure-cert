...
### [1] SYSTEM-USER prompt · 2026-06-17 21:55:34 UTC
...
</prompt>ori, zero-LLM-spend envelope gate (with a concrete applicability threshold), a confirmatory-vs-exploratory
...
<all_artifacts>
FULL EVIDENCE BASE: All 21 research artifacts across all iterations.
...
title: 'Spatial multi-path-redundancy gold-QCN corpus: iter-5 prevalence gate'
summary: |-
  A SPATIAL multi-path-redundant gold-QCN corpus that serves as an a-priori, descriptive prevalence gate for iter-5's second real-venue cross-path-intersection te
````

### [2] SKILL-INPUT — aii-paper-writing · 2026-06-17 21:56:24 UTC
...
### [3] SKILL-INPUT — aii-semscholar-bib · 2026-06-17 21:56:24 UTC
