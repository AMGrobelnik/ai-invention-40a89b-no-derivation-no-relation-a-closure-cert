# Zero-LLM T0 Envelope Gate + QCN Path-Consistency Engine over Temporal Corpora
...
Before spending any AI budget, this tool measures on three human-annotated temporal datasets where a logic-consistency checker could actually help, and decides which dataset to build the main experiment on.
