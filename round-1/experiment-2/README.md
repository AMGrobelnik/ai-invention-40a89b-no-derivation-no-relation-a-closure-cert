# Synthetic QCN de-risking of iterated closure (H3) and redundancy inverted-U (H4)
...
A from-scratch simulation shows that iteratively cross-checking inferred relations beats a single pass, that too much redundancy backfires below a recall-dependent sweet spot, and that contradictions get caught rather than silently faked.
